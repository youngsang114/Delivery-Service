...
public class TokenConverter {
    ...
    public TokenResponse toResponse(
        ...
        Objects.requireNonNull(accessToken, ()-> {throw new ApiException(ErrorCode.NULL_POINT,"Null AccessToken");});
        Objects.requireNonNull(refreshToken, ()-> {throw new ApiException(ErrorCode.NULL_POINT,"Null RefreshToken");});
